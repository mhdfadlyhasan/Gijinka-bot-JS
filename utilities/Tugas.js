...
module.exports = class Tugas {
    constructor(client, role, hari, jam, tanggal, deskripsi) {
        this.client = client
        this._role = role
        this.hari = hari
        this.jam = jam
...
//     }
    ...
    //         let date = new Date(Date.parse(this.tanggal))
    ...
    // }
//     setJadwalKelas(role, hari, jam, tanggal){
//         this.tanggal = tanggal
//         this._role = role
//         this.hari = hari
//         this.jam = jam
...
//                     el.stop()
//                 })
//                 console.log(`Cron Jobs for ${this.tanggal} has been succesfully stopped`)
//                 this._cronStr = []
//                 this.cronJobs = []
...
//                     var str = (minutesRemaining > 0) ? `REMINDER: ${minutesRemaining} menit lagi Tugas <@&${self.role}>` : `Tugas <@&${self.role}> di${mulai}`

//                     self.client.channels.get(self.client.channelID).send(str)
//                     console.log(`Notif Tugas ${self.tanggal} dikirim`)
//                 }, {
//                     scheduled: true,
//                     timezone: 'Asia/Jakarta'
//                 })
//                 count += 1
//                 console.log(`Created cron schedule for ${this.tanggal}`)
//             })
